...
def load_jobs():
    jobs = pd.read_csv(r"C:\Users\mschm\Desktop\Career_Path_Recommender_System\datasets\updated_jobs_grouped.csv", encoding='utf-8')
    return jobs
jobs = load_jobs()

def load_skills():
    ESCO = pd.ExcelFile(r"C:\Users\mschm\Desktop\Career_Path_Recommender_System\datasets\Merged Jobs.xlsx")
...
def recommend_career(selected_skills, selected_domain, data=jobs):
    ...
    #Remove spaces for multiworder skills to make them more comparable
